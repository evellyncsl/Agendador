package com.evellyn.agendador_horarios.services;

import com.evellyn.agendador_horarios.infrastructure.entity.Agendamento;
import com.evellyn.agendador_horarios.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    public Agendamento alterarAgendamento(Agendamento agendamento, String cliente, LocalDateTime dataHoraAgendamento){
        ...
        if(Objects.isNull(agenda)){
            throw new RuntimeException("Horário já está preenchido. Tente outro!");
        }
